package com.pakhomov.socialmedia.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> handleConstraintViolationException(ConstraintViolationException ex) {
        List<String> errors = ex.getConstraintName().equals("users_username_key") ?
                List.of("Username is already taken") : List.of("Email is already taken");
